...
class ShuttleBuilder:
    ...
    grid_mapping: dict[int, ir.SSAValue] = field(default_factory=dict)
    ...
    def construct_grid(
        ...
        self.grid_mapping[grid_id] = grid_ref
    ...
    def insert_move(
        ...
        x_dst = [dst[2] for dst in sorted_dsts]
        y_dst = [dst[3] for dst in sorted_dsts]
